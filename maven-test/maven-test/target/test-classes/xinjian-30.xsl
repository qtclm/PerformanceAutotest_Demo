...
<xsl:template name="summary">
	...
	<table align="center" class="details" border="0" cellpadding="5" cellspacing="2" width="95%">
		...
		<tr valign="top">
			...
			<td align="center">
				<xsl:call-template name="display-time">
					<xsl:with-param name="value" select="$allLineTime50" />
				</xsl:call-template>
			</td>
			<td align="center">
				<xsl:call-template name="display-time">
			...
			<td align="center">
				<xsl:call-template name="display-time">
					<xsl:with-param name="value" select="$allLineTime95" />
				</xsl:call-template>
			</td>
			<td align="center">
				<xsl:call-template name="display-time">
					<xsl:with-param name="value" select="$allLineTime99" />
				</xsl:call-template>
			</td>			
			<td align="center">
			...
			<td align="center">
				<xsl:call-template name="display-kb">
					<xsl:with-param name="value" select="$throuphputall" />
				</xsl:call-template>
			</td>
		</tr>
	</table>
	...
	<table align="center" class="details" border="0" cellpadding="5" cellspacing="2" width="95%">
		...
		<xsl:for-each select="/testResults/*[not(@lb = preceding::*/@lb)]"	>
			...
			<tr valign="top">
				...
				<td align="center">
					<xsl:call-template name="display-time">
						<xsl:with-param name="value" select="$nintyTime50" />
					</xsl:call-template>
				</td>
				<!-- Page页面添加90% LineTime -->
				<td align="center">
				...
				<td align="center">
					<xsl:call-template name="display-time">
						<xsl:with-param name="value" select="$nintyTime95" />
					</xsl:call-template>
				</td>
				<!-- Page页面添加99% LineTime -->
				<td align="center">
					<xsl:call-template name="display-time">
						<xsl:with-param name="value" select="$nintyTime99" />
					</xsl:call-template>
				</td>				
				<td align="center">
					<xsl:call-template name="display-qps">
				...
				<td align="center">
					<xsl:call-template name="display-kb">
						<xsl:with-param name="value" select="$throuphput" />
					</xsl:call-template>
				</td>
				<td align="center">
